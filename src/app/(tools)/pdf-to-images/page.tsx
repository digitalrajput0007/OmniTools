    ...
    if (isProcessing) {
      return (
        <div className="flex min-h-[300px] flex-col items-center justify-center space-y-4">
          ...
          <p className="text-center text-sm text-muted-foreground">Converting PDF pages to images...</p>
        </div>
      );
    }
      ...
      return (
         <div className="space-y-6">
            <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">All pages have been converted to images.</p>
            </div>
        ...
        return (
            <div className="flex flex-col items-center space-y-6">
                <div className="relative flex flex-col items-center justify-center space-y-4 rounded-md border p-8 w-full max-w-md">
                 ...
                 <Button onClick={handleConvert} size="lg" className="w-full max-w-md">
                    Convert to Images
                </Button>
            </div>
        );
