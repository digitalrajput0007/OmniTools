    ...
    <div className="container mx-auto max-w-4xl py-12 px-4 md:px-6">
      <Card>
        ...
        <CardContent className="prose prose-sm md:prose-base max-w-none text-muted-foreground space-y-4">
            <p className="text-red-500 font-bold">[IMPORTANT: This is a template. You must review and edit this policy to accurately reflect your data practices and consult with a legal professional to ensure compliance with laws like GDPR, CCPA, etc.]</p>
            ...
            <p>[**AdSense Requirement:** If you use Google AdSense, you MUST disclose the use of cookies for advertising. For example: "We use cookies to serve personalized ads through Google AdSense. Google's use of advertising cookies enables it and its partners to serve ads to our users based on their visit to our sites and/or other sites on the Internet."]</p>
